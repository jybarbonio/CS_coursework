...
public class Card
{
    ...
    public Card() 
    {
        this.CARD_IMG.setGraphic(new ImageView(new Image("file:img\\155.gif")));
        this.REF_IMG = new Image("file:img\\155.gif");
    }
    ...
    {
        CARD_IMG.setGraphic(new ImageView(PATH));
