...
class WarGame(object):
	...
	def resetCardImages(self):
		self.lblCardLeft.setPixmap(QPixmap(CardBack()))
		self.lblCardDeck.setPixmap(QPixmap(CardBack()))
		self.lblCardRight.setPixmap(QPixmap(CardBack()))
	...
	def mouseClick(self, event):
		...
		if(self.rightsTurn):
			...
			if(self.rightVal > self.leftVal):
				...
				score = score + self.cardRight.getSuit()
				...
				score = score + self.cardLeft.getSuit()
